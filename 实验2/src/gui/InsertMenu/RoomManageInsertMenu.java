...
public class RoomManageInsertMenu extends JFrame {
    private static final long serialVersionUID = 1158897003425269987L;
    private JPanel contentPane;
    public RoomManageInsertMenu()
    {
        //页面大小调整
        ...
        //提示文字
        JLabel lblid = new JLabel("输入要插入的房间事务");
        ...
        btnNewButton.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                ...
                String[] items = {mid, rid, rmcontent, rmtime};
                Insert insert = new Insert();
                insert.insertRoomManage(items);
            }
        });
    }
    public static void main(String[] args) {

        RoomManageInsertMenu frame = new RoomManageInsertMenu();
