...
public class LivingGoodsInsertMenu extends JFrame {
    private static final long serialVersionUID = 1158897003425269987L;
    private JPanel contentPane;
    public LivingGoodsInsertMenu()
    {
        //页面大小调整
        ...
        //提示文字
        JLabel lblid = new JLabel("输入要插入的物资信息");
        ...
        btnNewButton.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                ...
                String[] items = {lid, ltype, lprice};
                Insert insert = new Insert();
                insert.insertLivingGoods(items);
            }
        });
    }
    public static void main(String[] args) {

        LivingGoodsInsertMenu frame = new LivingGoodsInsertMenu();
