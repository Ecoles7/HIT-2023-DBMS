...
public class StaffUpdateMenu extends JFrame{
    ...
    public StaffUpdateMenu()
    {
        ...
        //提示文字
        JLabel lblid = new JLabel("输入要更新的员工信息");
    ...
    public static void main(String[] args) {
        EventQueue.invokeLater(new Runnable() {
            public void run() {
                try {
                    StaffUpdateMenu frame = new StaffUpdateMenu();
