...
public class RoomUpdateMenu extends JFrame{
    ...
    public RoomUpdateMenu()
    {
        ...
        //提示文字
        JLabel lblid = new JLabel("输入要更新的房间信息");
        ...
        JLabel lblid_3 = new JLabel("原房间号*");
        ...
        btnNewButton.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                ...
                String oldrid = textField_2.getText();
                String[] items = {rid, bednum, oldrid};
                Update update = new Update();
                update.updateRoom(items);
            }
        });
    }
    public static void main(String[] args) {
        EventQueue.invokeLater(new Runnable() {
            public void run() {
                try {
                    RoomUpdateMenu frame = new RoomUpdateMenu();
