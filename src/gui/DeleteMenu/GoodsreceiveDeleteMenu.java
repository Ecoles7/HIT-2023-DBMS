...
public class GoodsreceiveDeleteMenu extends JFrame{
    private static final long serialVersionUID = 1158897003425269987L;
    private JPanel contentPane;
    public GoodsreceiveDeleteMenu()
    {
        //页面大小调整
        ...
        //提示文字
        JLabel lblid = new JLabel("输入要删除的物资领取信息");
        ...
        btnNewButton.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                ...
                String[] items = {lid, sid};
                Delete delete=new Delete();
                delete.deleteGoodsreceive(items);
            }
        });
    }
}
