...
public class OccuCertiInsertMenu extends JFrame {
    private static final long serialVersionUID = 1158897003425269987L;
    private JPanel contentPane;
    public OccuCertiInsertMenu()
    {
        //页面大小调整
        ...
        //提示文字
        JLabel lblid = new JLabel("输入要插入的入住证明信息");
    ...
    public static void main(String[] args) {
        OccuCertiInsertMenu frame = new OccuCertiInsertMenu();
