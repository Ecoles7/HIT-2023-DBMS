...
public class GoodsreceiveInsertMenu extends JFrame {
    private static final long serialVersionUID = 1158897003425269987L;
    private JPanel contentPane;
    public GoodsreceiveInsertMenu()
    {
        //页面大小调整
        ...
        //提示文字
        JLabel lblid = new JLabel("输入要插入的物资领取信息");
        ...
        btnNewButton.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                ...
                insert.insertGoodsreceive(items);
            }
        });
    }
    public static void main(String[] args) {
        GoodsreceiveInsertMenu frame = new GoodsreceiveInsertMenu();
