...
public class StaffOccuInsertMenu extends JFrame{
    private static final long serialVersionUID = 1158897003425269987L;
    private JPanel contentPane;
    public StaffOccuInsertMenu()
    {
        //页面大小调整
        ...
        //提示文字
        JLabel lblid = new JLabel("输入要插入的员工入住信息");
        ...
        btnNewButton.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                ...
                String[] items = {rid, bedid, sid, occuTime};
    ...
    public static void main(String[] args) {
        ...
        StaffOccuInsertMenu frame = new StaffOccuInsertMenu();
