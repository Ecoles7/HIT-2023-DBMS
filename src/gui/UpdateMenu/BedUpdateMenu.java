...
public class BedUpdateMenu extends JFrame{
    ...
    public BedUpdateMenu()
    {
        ...
        //提示文字
        JLabel lblid = new JLabel("输入要更新的床铺信息");
        ...
        JLabel lblid_3 = new JLabel("床铺类型*");
        ...
        JLabel lblid_4 = new JLabel("原房间号*");
        ...
        btnNewButton.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                ...
                String bedType = textField_2.getText();
                String rid_b= textField_3.getText();
                String bedid_b = textField_4.getText();
                String[] items = {rid, bedid, bedType, rid_b, bedid_b};
                Update update = new Update();
                update.updateBed(items);
            }
        });
    }
    public static void main(String[] args) {
        BedUpdateMenu frame = new BedUpdateMenu();
