...
public class GoodsreceiveUpdateMenu extends JFrame {
    private static final long serialVersionUID = 1158897003425269987L;
    private JPanel contentPane;
    public GoodsreceiveUpdateMenu()
    {
        //页面大小调整
        ...
        //提示文字
        JLabel lblid = new JLabel("输入要更新的物资领取信息");
        ...
        JLabel lblid_3 = new JLabel("领取时间*");
        ...
        JLabel lblid_4 = new JLabel("领取数量*");
        ...
        JLabel lblid_5 = new JLabel("原物资号*");
        ...
        JLabel lblid_7 = new JLabel("原领取时间*");
        ...
        JLabel lblid_8 = new JLabel("原领取数量*");
        ...
        btnNewButton.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                ...
                String retime = textField_2.getText();
                String renum = textField_3.getText();;
                String[] items = {lid, sid, retime, renum};
                Update update = new Update();
                update.updateGoodsreceive(items);
            }
        });
    }
    public static void main(String[] args) {

        GoodsreceiveUpdateMenu frame = new GoodsreceiveUpdateMenu();
